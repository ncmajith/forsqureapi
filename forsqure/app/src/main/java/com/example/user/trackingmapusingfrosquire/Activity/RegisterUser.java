...
public class RegisterUser extends AppCompatActivity {
    ...
    public void registerUser(View view)
    {
       ...
       String replay=db.addUser(new Tb_User(name.getText().toString(),email.getText().toString(),phone.getText().toString(),username.getText().toString(),password.getText().toString(),Food,place,holi,topspot));
